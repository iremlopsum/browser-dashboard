...
import type { CounterPropsType, DigitPropsType, NumberPropsType } from '../../types/components'
 ...
 *
 * @param {NumberPropsType} props - Component props
 * @returns {JSX.Element} Animated digit span element
 */
function Number({ mv, number, height }: NumberPropsType) {
 ...
 *
 * @param {DigitPropsType} props - Component props
 * @returns {JSX.Element} Digit container with animated number display
 */
function Digit({ place, value, height, digitStyle }: DigitPropsType) {
 ...
 *
 * @param {CounterPropsType} props - Component props
